...
#     # Проверки
#     all_cards = [*my_cards, *op_cards, *table, *table1, *table2]
#     unique_cards = len(c) == len(set(c))
#     correct_distribution = all_cards == c[:9]
    
#     print(f'\nВсе карты в колоде уникальны: {unique_cards}')
#     print(f'Первые 9 карт из колоды совпадают с картами игроков и картами на столе: {correct_distribution}')
    
#     show_deck(all_cards)
#     show_deck(c[:9])

#     is_game_correct = all([unique_cards, correct_distribution])
...
#     # Проверки
#     all_cards = [*op_cards, *my_cards, *table, *table1, *table2]
#     unique_cards = len(c) == len(set(c))
#     correct_distribution = all_cards == c[:9]
